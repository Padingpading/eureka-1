...
public interface EurekaInstanceConfig {
     ...
     *  实例在注册eureka后，是否能够立即处理请求，可以需要一些处理来可以准备好
     */
     ...
     * renew --> 续约
     * 获取最少续约间隔时长，eureka会按照这个时间不断的发送心跳，
     * 当eureka server超过最大频率，没有接收到心跳，将会移除该实例
     */
     ...
     * 获取最少过期间隔时长， 超过这个时间没有接受到实例的心跳，可以认为该实例已经失败
     */
